...
<div class="hound-search-form-wrapper text-center">
	<form role="search" action="#" class="hound-search-form hound-search-border flex" autocomplete="off" aria-label="Search form">
		<input aria-label="Search input" type="search" id="hound-search-input-field" class="hound-search-form-input" name="phrase" placeholder="<?php echo esc_attr( $placeholder ); ?>" value="<?php echo esc_attr( $value ); ?>" autocomplete="off">
